  ...
  \begin{columns}
    ...
    \column{0.4\textwidth}
      \begin{alertblock}{Core Challenge}
        \justifying
        Balancing the hallucination risks of LLMs with the rigidity of SPARQL queries to ensure factual accuracy.
      \end{alertblock}
  \end{columns}
\end{frame}
...
\begin{frame}{Experimental Results Summary}
  \begin{table}
    \centering
    \caption{Performance on Test Queries}
    \begin{tabular}{lcc}
      \toprule
      \textbf{Metric} & \textbf{Value} & \textbf{Notes} \\
      \midrule
      Intent Accuracy & $\sim$92\% & BERT fine-tuning \\
      Entity Linking & High & Threshold-based (85+) \\
      Time Parsing & Robust & Handles typos ("munutes") \\
      \bottomrule
    \end{tabular}
  \end{table}
